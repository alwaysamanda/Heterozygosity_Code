...
def calc_het(roh_file, chromosome_length_file, window_length, window_interval, clade, full_species_name, chrom, output):
    ...
    if chrom_length < 100000:
        ...
        var_file = os.path.join("../groups", clade, full_species_name, "heterozygosity/temp", chrom_name+"_Var_Only.txt")
...
run_het_calculations = calc_het(roh_file, chromosome_length_file, window_length, window_interval, clade, full_species_name, chrom_name, output)

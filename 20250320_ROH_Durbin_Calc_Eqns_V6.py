...
## Date: 20250320 (March 20th, 2025)
## Author: Amanda Gardiner
## Version 6 (V5 is 20250311_ROH_Durbin_Calc_Eqns_V5.py)
## NOTES: 
...
# def read_var_file(variant_file):
#     var_lines = [line.split() for line in variant_file.readlines()]
#     var_pos = [int(line[2]) for line in var_lines]
#     return var_lines, var_pos

# var_list, var_pos = read_var_file(Var_file)
# print(var_list)
# print(var_pos) # List of variant positions
